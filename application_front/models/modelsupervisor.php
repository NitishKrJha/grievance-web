...
class ModelSupervisor extends CI_Model {
	...
	function getList(&$config,&$start,&$param,$memberID)
	{
		...
		//==============================================================
		$this->db->select('COUNT(grievances.id) as TotalrecordCount');
	...
	function getDetailById($id){
		$this->db->select('grievances.*,department.name as department_name,member.first_name,member.middle_name,member.last_name,member.phone as modifier_phone,member.phone as modifier_email');
