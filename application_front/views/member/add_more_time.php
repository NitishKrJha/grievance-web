        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="btm-section payment">
                    <h2>Summary</h2>
                    <div class="bx grayBx">
                        <h3>100 minutes Plan <span>: $10</span></h3>
                    </div>
                    <h2>Personal Details</h2>
                    <form action="<?php echo base_url('member/doMembershipPaymentForVideo'); ?>" id="membershipPayment" method="post">
                    <div class="bx whitBx">
                        <div class="row">
    ...
    $(document).ready(function(){
        $("#membershipPayment").validate({
            ...
            submitHandler: function(form) {
                //form.submit();
                $.ajax({
                    url:"<?php echo base_url('member/doMembershipPaymentForVideo') ?>",
                    type:"Post",
                    ...
                    success:function(data){
                        if(data.error==0){
                            window.location.href="<?php echo base_url('member/mymatch') ?>";
                        }else{
