				  ...
				  <li><a href="javascript:void(0);" class="makeCanceled" data-id="<?php echo $memberId;?>"><i class="fa fa-ban" aria-hidden="true" data-toggle="tooltip" title="Block"></i></a></li>
                   ...
                   <?php if($profileView==1){ ?>
                    ...
                    <?php if(($membership_expire_date!='' && $membership_expire_date >= date('Y-m-d')) && ($exp_date!='' && $exp_date>=date('Y-m-d'))){?>
                        <li><a href="javascript:void(0);" class="openVideoBox" identifier="<?=$memberId?>"><i class="fa fa-video-camera" aria-hidden="true"></i> </a></li>
                        <?php } ?>
                        <li><a href="javascript:void(0);" identifier="<?=$memberId?>" class="chatShowHidePre"><input type="hidden" value="<?php echo $val['name'];?>" class="h_name<?php echo $memberId;?>" id="h_name<?php echo $val['member_id'];?>" /><input type="hidden" value="<?php echo $pic;?>" id="h_pic<?php echo $memberId;?>" /><i class="fa fa-comment-o" aria-hidden="true"></i> </a></li>
                    <?php } ?>
                </ul>
            </div>
        </div>
