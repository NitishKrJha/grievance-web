...
class CI_Pagination {
	...
	function setFrontPaginationStyle(&$config)
	{
		$config['full_tag_open'] = '<div class="col-sm-7"><div class="dataTables_paginate paging_simple_numbers" id="example2_paginate"><ul class="pagination">';
		$config['full_tag_close'] = '</ul></div></div>';
	
		$config['first_tag_open'] = '<li class="paginate_button previous disabled" id="example2_previous">';
		...
		$config['next_tag_open'] = '<li id="example2_previous" class="paginate_button previous">';
		$config['next_tag_close'] = '</li>';

	}
	function setAdminPaginationStyle(&$config)
	{
		$config['full_tag_open'] = '<div class="col-sm-11"><div class="dataTables_paginate paging_simple_numbers" id="example2_paginate"><ul class="pagination">';
		$config['full_tag_close'] = '</ul></div></div>';
		...
		$config['cur_tag_open'] = '<li class="paginate_button active dissabled"><a href="#" aria-controls="example2" data-dt-idx="2" tabindex="0">';
	...
	function create_dropdown_links()
	{
		...
		else
		{
  		...
  		// And here we go...
		$output = '<select name="example1_length" aria-controls="example1" class="form-control input-sm">';
