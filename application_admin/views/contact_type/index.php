    ...
    <div class="x_content">
      ...
      <div class="table-responsive">
        <table class="table table-striped jambo_table bulk_action">
          <thead>
            <tr class="headings">
			<th class="column-title">Contact Industry</th>
              <th class="column-title"><?php echo tableOrdering("Title","contact_type.title",$params['sortField'],$params['sortType']); ?> </th>
          ...
          <?php if(!empty($recordset)){ $i=2; ?>
            ...
            <tr class="<?php echo $i%2==0?'even':'odd'; ?> pointer">
			  <td class=" "><?php echo $singleRecord['contact_industry_title']; ?></td>
