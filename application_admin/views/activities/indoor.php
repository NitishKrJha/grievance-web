        ...
        <table class="table table-striped jambo_table bulk_action">
          ...
          <?php if(!empty($recordset)){ $i=2; ?>
            ...
            <tr class="<?php echo $i%2==0?'even':'odd'; ?> pointer">
              ...
              <td class=" last"><a href="<?php echo $ediLink; ?>" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a> ||  <a onclick="return confirm('Are you sure.You want to delete?')" href="<?php echo base_url('activities/indoor_delete/'.$singleRecord['id']) ?>" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
            </tr>
          <?php  $i++; }
