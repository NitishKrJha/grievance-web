		...
		<form id="form1" class="form-horizontal" action="<?php echo $do_addedit_link;?>" method="post" enctype="multipart/form-data">
			<span class="section">Counselor</span>
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
					   <input class="validate[required] form-control" type="text" id="username" name="username" value="<?php echo $username;?>" <?php if($action=='Edit'){?>readonly<?php } ?>>
					   <?php echo form_error('email'); ?>
					</div>
				</div>
        		<?php if($action=='Add'){?>
        		...
        		<?php } ?>
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">About Me <span class="required">*</span></label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input class="validate[required] form-control" type="text" id="username" name="username" value="<?php echo $username;?>" <?php if($action=='Edit'){?>readonly<?php } ?>>
                </div>
            </div>
