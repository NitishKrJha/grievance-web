...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      <li><a title="Add Counselor" href="<?php echo $add_link; ?>"><i class="fa fa-plus"></i></a>
          </li>
        </ul>
      </div>
      <div class="clearfix"></div>
        ...
        <table class="table table-striped jambo_table bulk_action">
          ...
          <?php if(!empty($recordset)){ $i=2; ?>
            ...
            <tr class="<?php echo $i%2==0?'even':'odd'; ?> pointer">
              ...
              <td class=" last"><a href="<?php echo $ediLink; ?>" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a> ||  <a href="<?php echo base_url('counselor/delete/'.$singleRecord['id']) ?>" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
            </tr>
          <?php  $i++; }
