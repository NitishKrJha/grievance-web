    ...
    <div class="x_content">
          ...
          <div class="col-md-4 form-group">
            <select class="form-control" aria-controls="example" name="searchField">
                  <option value="">-Select-</option>
                   <option value="supplier_type.supplier_number" <?php if(isset($params['searchField']) && $params['searchField']=='supplier_type.supplier_number') echo 'selected';?>>Number</option>
      ...
      <div class="table-responsive">
        <table class="table table-striped jambo_table bulk_action">
          <thead>
            <tr class="headings">
              <th class="column-title"><?php echo tableOrdering("Number","supplier_type.supplier_number",$params['sortField'],$params['sortType']); ?> </th>
          ...
          <?php if(!empty($recordset)){ $i=2; ?>
            ...
            <tr class="<?php echo $i%2==0?'even':'odd'; ?> pointer">
              <td class=" "><?php echo $singleRecord['supplier_number']; ?></td>
              <td class=" "><?php echo $singleRecord['supplier_desc']; ?></td>
