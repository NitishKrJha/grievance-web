...
$(document).on('click','#send',function(){
	...
	var ending_range = $("input[name='ending_range[]']")
              .map(function(){return $(this).val();}).get();
	//console.log("starting_range: "+starting_range);
	//console.log("ending_range: "+ending_range);
...
<div class="form-group col-md-12 newelem">
	...
	<div class="col-md-3"><input class="form-control price_val" name="price[]" type="text"></div>
