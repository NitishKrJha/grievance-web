        ...
        <table class="table table-striped jambo_table bulk_action">
          <thead>
            <tr class="headings">
				...
				<th class="column-title">Price Per Unit</th>
				<th class="column-title">Summary File to Use</th>
				<th class="column-title">Minimum Order Amount</th>
          ...
          <?php if(!empty($recordset)){ $i=2;$j=1; ?>
            ...
            <tr class="<?php echo $i%2==0?'even':'odd'; ?> pointer">
			  ...
			  <td class=" "><?php echo $singleRecord['uom']; ?></td>
			  <td class=" "><?php echo $singleRecord['price_per_unit']; ?></td>
			  <td class=" "><?php echo $singleRecord['file_to_use_name']; ?></td>
			  <td class=" "><?php echo $singleRecord['minimum_order_amt']; ?></td>
