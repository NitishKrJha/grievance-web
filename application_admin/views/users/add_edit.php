...
$(document).ready(function(){
 ...
 $("#country_id").change(function(){
    ...
    $.ajax({
      url : '<?php echo base_url("users/getCountry");?>',
      type : 'POST',
  ...
  $("#form1").validate({
      ...
      rules: {
        ...
        email:{
            ...
            email: true,
            remote: {
                  url: "<?php echo base_url('users/emailExist/'.$id); ?>",
                  type: "post"
            }
        },
        crn:{
            required: true,
            remote: {
                  url: "<?php echo base_url('users/crnExist/'.$id); ?>",
                  type: "post"
            }
        },
        phone:{
            required: true,
            remote: {
                  url: "<?php echo base_url('users/phoneExist/'.$id); ?>",
                  type: "post"
            }
        }
      },
